...
public class NeapolitanBlockEntityTypes {
	...
	public static final RegistryObject<BlockEntityType<NeapolitanSkullBlockEntity>> SKULL = HELPER.createBlockEntity("skull", NeapolitanSkullBlockEntity::new, () -> new Block[]{NeapolitanBlocks.CHIMPANZEE_HEAD.get(), NeapolitanBlocks.CHIMPANZEE_WALL_HEAD.get()});
}