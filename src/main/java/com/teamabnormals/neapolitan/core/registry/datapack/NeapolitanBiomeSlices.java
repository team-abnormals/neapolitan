...
import static com.teamabnormals.neapolitan.core.registry.datapack.NeapolitanBiomes.STRAWBERRY_FIELDS;
...
public final class NeapolitanBiomeSlices {
	...
	public static ResourceKey<ModdedBiomeSlice> createKey(String name) {
		return ResourceKey.create(BlueprintDataPackRegistries.MODDED_BIOME_SLICES, Neapolitan.location(name));
	}
