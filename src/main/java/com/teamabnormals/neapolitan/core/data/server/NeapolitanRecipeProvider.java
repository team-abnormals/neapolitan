...
public class NeapolitanRecipeProvider extends BlueprintRecipeProvider {
	...
	public void buildRecipes(RecipeOutput consumer, HolderLookup.Provider provider) {
		...
		flavorRecipes(consumer, provider, NeapolitanItemTags.FOODS_BANANA, getHasName(BANANA), NeapolitanIceCreamFlavors.BANANA, BANANA_MILKSHAKE, NeapolitanItems.BANANA_CAKE, BANANA_ICE_CREAM_BLOCK);
		...
		flavorRecipes(consumer, provider, NeapolitanItemTags.FOODS_CHOCOLATE_BAR, getHasName(CHOCOLATE_BAR), NeapolitanIceCreamFlavors.CHOCOLATE, CHOCOLATE_MILKSHAKE, NeapolitanItems.CHOCOLATE_CAKE, CHOCOLATE_ICE_CREAM_BLOCK);
		...
		flavorRecipes(consumer, provider, MINT_LEAVES, NeapolitanIceCreamFlavors.MINT, MINT_MILKSHAKE, NeapolitanItems.MINT_CAKE, MINT_ICE_CREAM_BLOCK);
		...
		flavorRecipes(consumer, provider, NeapolitanItemTags.FOODS_STRAWBERRY, getHasName(STRAWBERRIES), NeapolitanIceCreamFlavors.STRAWBERRY, STRAWBERRY_MILKSHAKE, NeapolitanItems.STRAWBERRY_CAKE, STRAWBERRY_ICE_CREAM_BLOCK);
	...
	public static void flavorRecipes(RecipeOutput consumer, HolderLookup.Provider provider, ItemLike item, ResourceKey<IceCreamFlavor> flavor, ItemLike milkshake, ItemLike cake, ItemLike iceCreamBlock) {
		flavorRecipes(consumer, provider, Ingredient.of(item), flavor, milkshake, cake, iceCreamBlock, getHasName(item), has(item));
	}

	public static void flavorRecipes(RecipeOutput consumer, HolderLookup.Provider provider, TagKey<Item> tag, String hasName, ResourceKey<IceCreamFlavor> flavor, ItemLike milkshake, ItemLike cake, ItemLike iceCreamBlock) {
		flavorRecipes(consumer, provider, Ingredient.of(tag), flavor, milkshake, cake, iceCreamBlock, hasName, has(tag));
	}

	public static void flavorRecipes(RecipeOutput consumer, HolderLookup.Provider provider, Ingredient ingredient, ResourceKey<IceCreamFlavor> flavor, ItemLike milkshake, ItemLike cake, ItemLike iceCreamBlock, String hasName, Criterion<?> has) {
		RegistryLookup<IceCreamFlavor> lookup = provider.lookupOrThrow(NeapolitanRegistries.ICE_CREAM_FLAVOR);
		Ingredient iceCream = DataComponentIngredient.of(false, DataComponentPredicate.builder().expect(NeapolitanDataComponents.ICE_CREAM.get(), new IceCream(lookup.getOrThrow(flavor))).build(), ICE_CREAM.get(), ICE_CREAM_CONE.get());
