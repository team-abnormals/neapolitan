...
public class NeapolitanRecipeProvider extends BlueprintRecipeProvider {
	...
	public void buildRecipes(RecipeOutput consumer, HolderLookup.Provider provider) {
		...
		Ingredient iceCream = DataComponentIngredient.of(false, DataComponentPredicate.builder().expect(NeapolitanDataComponents.ICE_CREAM.get(), new IceCream(NeapolitanIceCreamFlavors.SNOW)).build(), ICE_CREAM.get(), ICE_CREAM_CONE.get());
		...
		flavorRecipes(consumer, ROASTED_ADZUKI_BEANS, NeapolitanIceCreamFlavors.ADZUKI, ADZUKI_MILKSHAKE, NeapolitanItems.ADZUKI_CAKE, ADZUKI_ICE_CREAM_BLOCK);
		...
		flavorRecipes(consumer, NeapolitanItemTags.FOODS_BANANA, getHasName(BANANA), NeapolitanIceCreamFlavors.BANANA, BANANA_MILKSHAKE, NeapolitanItems.BANANA_CAKE, BANANA_ICE_CREAM_BLOCK);
		...
		flavorRecipes(consumer, NeapolitanItemTags.FOODS_CHOCOLATE_BAR, getHasName(CHOCOLATE_BAR), NeapolitanIceCreamFlavors.CHOCOLATE, CHOCOLATE_MILKSHAKE, NeapolitanItems.CHOCOLATE_CAKE, CHOCOLATE_ICE_CREAM_BLOCK);
		...
		flavorRecipes(consumer, MINT_LEAVES, NeapolitanIceCreamFlavors.MINT, MINT_MILKSHAKE, NeapolitanItems.MINT_CAKE, MINT_ICE_CREAM_BLOCK);
		...
		flavorRecipes(consumer, NeapolitanItemTags.FOODS_STRAWBERRY, getHasName(STRAWBERRIES), NeapolitanIceCreamFlavors.STRAWBERRY, STRAWBERRY_MILKSHAKE, NeapolitanItems.STRAWBERRY_CAKE, STRAWBERRY_ICE_CREAM_BLOCK);
		...
		flavorRecipes(consumer, DRIED_VANILLA_PODS, NeapolitanIceCreamFlavors.VANILLA, VANILLA_MILKSHAKE, NeapolitanItems.VANILLA_CAKE, VANILLA_ICE_CREAM_BLOCK);
	...
	public static void flavorRecipes(RecipeOutput consumer, ItemLike item, ResourceKey<IceCreamFlavor> flavor, ItemLike milkshake, ItemLike cake, ItemLike iceCreamBlock) {
		flavorRecipes(consumer, Ingredient.of(item), flavor, milkshake, cake, iceCreamBlock, getHasName(item), has(item));
	}

	public static void flavorRecipes(RecipeOutput consumer, TagKey<Item> tag, String hasName, ResourceKey<IceCreamFlavor> flavor, ItemLike milkshake, ItemLike cake, ItemLike iceCreamBlock) {
		flavorRecipes(consumer, Ingredient.of(tag), flavor, milkshake, cake, iceCreamBlock, hasName, has(tag));
	}

	public static void flavorRecipes(RecipeOutput consumer, Ingredient ingredient, ResourceKey<IceCreamFlavor> flavor, ItemLike milkshake, ItemLike cake, ItemLike iceCreamBlock, String hasName, Criterion<?> has) {
		Ingredient iceCream = DataComponentIngredient.of(false, DataComponentPredicate.builder().expect(NeapolitanDataComponents.ICE_CREAM.get(), new IceCream(flavor)).build(), ICE_CREAM.get(), ICE_CREAM_CONE.get());
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, milkshake, 3).requires(GLASS_BOTTLE, 3).requires(iceCream).requires(BlueprintItemTags.MILK).unlockedBy(getHasName(ICE_CREAM), has(NeapolitanItemTags.FOODS_ICE_CREAM)).save(consumer);
		ShapedRecipeBuilder.shaped(RecipeCategory.FOOD, iceCreamBlock, 8).pattern("###").pattern("#X#").pattern("###").define('X', iceCream).define('#', SNOW_BLOCK).unlockedBy(getHasName(ICE_CREAM), has(NeapolitanItemTags.FOODS_ICE_CREAM)).save(consumer);
	}
