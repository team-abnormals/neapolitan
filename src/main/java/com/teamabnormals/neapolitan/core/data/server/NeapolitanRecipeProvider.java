...
public class NeapolitanRecipeProvider extends BlueprintRecipeProvider {
	...
	public void buildRecipes(RecipeOutput consumer) {
		...
		flavorRecipes(consumer, ROASTED_ADZUKI_BEANS, NeapolitanFlavors.ADZUKI, ADZUKI_MILKSHAKE, NeapolitanItems.ADZUKI_CAKE, ADZUKI_ICE_CREAM_BLOCK);
		...
		flavorRecipes(consumer, NeapolitanItemTags.FOODS_BANANA, getHasName(BANANA), NeapolitanFlavors.BANANA, BANANA_MILKSHAKE, NeapolitanItems.BANANA_CAKE, BANANA_ICE_CREAM_BLOCK);
		...
		flavorRecipes(consumer, NeapolitanItemTags.FOODS_CHOCOLATE_BAR, getHasName(CHOCOLATE_BAR), NeapolitanFlavors.CHOCOLATE, CHOCOLATE_MILKSHAKE, NeapolitanItems.CHOCOLATE_CAKE, CHOCOLATE_ICE_CREAM_BLOCK);
		...
		flavorRecipes(consumer, MINT_LEAVES, NeapolitanFlavors.MINT, MINT_MILKSHAKE, NeapolitanItems.MINT_CAKE, MINT_ICE_CREAM_BLOCK);
		...
		flavorRecipes(consumer, NeapolitanItemTags.FOODS_STRAWBERRY, getHasName(STRAWBERRIES), NeapolitanFlavors.STRAWBERRY, STRAWBERRY_MILKSHAKE, NeapolitanItems.STRAWBERRY_CAKE, STRAWBERRY_ICE_CREAM_BLOCK);
		...
		flavorRecipes(consumer, DRIED_VANILLA_PODS, NeapolitanFlavors.VANILLA, VANILLA_MILKSHAKE, NeapolitanItems.VANILLA_CAKE, VANILLA_ICE_CREAM_BLOCK);
