...
public class NeapolitanBlockTagsProvider extends BlockTagsProvider {
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		this.tag(BlockTags.MINEABLE_WITH_AXE).add(
				CHOCOLATE_BLOCK.get(), CHOCOLATE_BRICKS.get(), CHOCOLATE_BRICK_SLAB.get(), CHOCOLATE_BRICK_STAIRS.get(), CHOCOLATE_BRICK_WALL.get(), CHISELED_CHOCOLATE_BRICKS.get(), CHOCOLATE_TILES.get(), CHOCOLATE_TILE_SLAB.get(), CHOCOLATE_TILE_STAIRS.get(), CHOCOLATE_TILE_WALL.get(),
				WAFFLE_CONE_BLOCK.get(), WAFFLE_CONE_TILES.get(), WAFFLE_CONE_TILE_STAIRS.get(), WAFFLE_CONE_TILE_SLAB.get(), WAFFLE_CONE_TILE_WALL.get(), WAFFLE_CONE_PILLAR.get(),
				STRAWBERRY_BUSH.get(), VANILLA_VINE.get(), VANILLA_VINE_PLANT.get(), MINT.get(), ADZUKI_SPROUTS.get(), STRAWBERRY_BASKET.get(), WHITE_STRAWBERRY_BASKET.get(), BANANA_CRATE.get(), MINT_BASKET.get(), ADZUKI_CRATE.get(), ROASTED_ADZUKI_CRATE.get()
		);
		...
		this.tag(Tags.Blocks.STORAGE_BLOCKS).add(CHOCOLATE_BLOCK.get(), VANILLA_POD_BLOCK.get(), DRIED_VANILLA_POD_BLOCK.get(), STRAWBERRY_BASKET.get(), WHITE_STRAWBERRY_BASKET.get(), BANANA_CRATE.get(), MINT_BASKET.get(), ADZUKI_CRATE.get(), ROASTED_ADZUKI_CRATE.get(), SUGAR_CANE_BLOCK.get(), SUGAR_SACK.get(), COCOA_BEAN_SACK.get(), WAFFLE_CONE_BLOCK.get());
