...
public class NeapolitanBlockTagsProvider extends BlockTagsProvider {
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		this.tag(BlockTags.MINEABLE_WITH_HOE).add(FROND_THATCH.get(), FROND_THATCH_SLAB.get(), FROND_THATCH_STAIRS.get(), BANANA_STALK.get(), CARVED_BANANA_STALK.get(), BANANA_FROND.get(), BEANSTALK.get(), BEANSTALK_THORNS.get(), VANILLA_POD_BLOCK.get(), DRIED_VANILLA_POD_BLOCK.get(), BANANA_BUNDLE.get(), SUGAR_CANE_BUNDLE.get(), SUGAR_SACK.get(), COCOA_BEAN_SACK.get());
		...
		this.tag(Tags.Blocks.STORAGE_BLOCKS).add(CHOCOLATE_BLOCK.get(), VANILLA_POD_BLOCK.get(), DRIED_VANILLA_POD_BLOCK.get(), STRAWBERRY_BASKET.get(), WHITE_STRAWBERRY_BASKET.get(), BANANA_CRATE.get(), MINT_BASKET.get(), ADZUKI_CRATE.get(), ROASTED_ADZUKI_CRATE.get(), SUGAR_CANE_BUNDLE.get(), SUGAR_SACK.get(), COCOA_BEAN_SACK.get());
