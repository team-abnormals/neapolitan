...
public class NeapolitanItemTagsProvider extends ItemTagsProvider {
	...
	public void addTags(HolderLookup.Provider provider) {
		...
		this.tag(ICE_CREAM_FLAVORS).add(Items.SNOWBALL, DRIED_VANILLA_PODS.get(), CHOCOLATE_BAR.get(), STRAWBERRIES.get(), BANANA.get(), MINT_LEAVES.get(), ROASTED_ADZUKI_BEANS.get(), MANGO.get(), CINNAMON_STICKS.get(), BUBBLEGUM.get());
