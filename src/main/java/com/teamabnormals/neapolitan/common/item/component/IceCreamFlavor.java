...
public record IceCreamFlavor(Holder<Item> ingredient, Component description, Optional<Holder<Block>> milkshakeCauldron) {
	...
	public static IceCreamFlavor create(Item ingredient, Component description, Block cauldron) {
		return new IceCreamFlavor(BuiltInRegistries.ITEM.wrapAsHolder(ingredient), description, Optional.of(BuiltInRegistries.BLOCK.wrapAsHolder(cauldron)));
	}
