...
public class BananarrowRenderer extends ArrowRenderer<Bananarrow> {
	private static final ResourceLocation BANANARROW = Neapolitan.location("textures/entity/projectiles/bananarrow.png");
	private static final ResourceLocation ARROW = ResourceLocation.withDefaultNamespace("textures/entity/projectiles/arrow.png");
