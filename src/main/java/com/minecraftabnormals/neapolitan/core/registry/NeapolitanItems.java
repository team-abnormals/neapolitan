...
public class NeapolitanItems {
	...
	public static final RegistryObject<Item> STRAWBERRY_MILKSHAKE = HELPER.createItem("strawberry_milkshake", () -> new MilkshakeItem(EffectType.HARMFUL, new Item.Properties().food(Foods.STRAWBERRY_MILKSHAKE).containerItem(Items.GLASS_BOTTLE).maxStackSize(16).group(ItemGroup.FOOD)));
	...
	public static final RegistryObject<Item> MINT_MILKSHAKE = HELPER.createItem("mint_milkshake", () -> new MilkshakeItem(null, new Item.Properties().food(Foods.MINT_MILKSHAKE).maxStackSize(16).group(ItemGroup.FOOD)));
	...
	public static final RegistryObject<Item> ADZUKI_BEANS = HELPER.createItem("adzuki_beans", () -> new Item(new Item.Properties().food(Foods.ADZUKI_BEANS).group(ItemGroup.FOOD)));
	...
	public static final RegistryObject<Item> MAGIC_BEANS = HELPER.createItem("magic_beans", () -> new Item(new Item.Properties().group(ItemGroup.MISC)));
	...
	public static final RegistryObject<Item> ADZUKI_MILKSHAKE = HELPER.createItem("adzuki_milkshake", () -> new MilkshakeItem(null, new Item.Properties().food(Foods.ADZUKI_MILKSHAKE).maxStackSize(16).group(ItemGroup.FOOD)));
	...
	static class Foods {
		...
		public static final Food MINT_LEAVES = (new Food.Builder()).hunger(2).saturation(0.2F).effect(() -> new EffectInstance(NeapolitanEffects.BERSERKING.get(), 300), 1.0F).build();
		public static final Food MINT_ICE_CREAM = (new Food.Builder()).hunger(6).saturation(0.42F).effect(() -> new EffectInstance(Effects.SLOWNESS, 100, 2), 1.0F).effect(() -> new EffectInstance(NeapolitanEffects.BERSERKING.get(), 1200), 1.0F).build();
		public static final Food COOKED_MINT_CHOPS = (new Food.Builder()).hunger(5).saturation(0.6F).effect(() -> new EffectInstance(NeapolitanEffects.BERSERKING.get(), 600), 1.0F).build();
		public static final Food MINT_CHOPS = (new Food.Builder()).hunger(4).saturation(0.3F).effect(() -> new EffectInstance(NeapolitanEffects.BERSERKING.get(), 200), 1.0F).build();
		public static final Food MINT_MILKSHAKE = (new Food.Builder()).hunger(3).saturation(0.6F).build();
		public static final Food MINT_CAKE = (new Food.Builder()).hunger(1).saturation(0.1F).effect(() -> new EffectInstance(NeapolitanEffects.BERSERKING.get(), 200), 1.0F).build();
		public static final Food MINT_CANDIES = (new Food.Builder()).hunger(4).saturation(0.3F).effect(() -> new EffectInstance(NeapolitanEffects.BERSERKING.get(), 200), 1.0F).build();

		public static final Food ADZUKI_BEANS = (new Food.Builder()).hunger(2).saturation(0.2F).effect(() -> new EffectInstance(NeapolitanEffects.HARMONY.get(), 300), 1.0F).build();
		public static final Food ADZUKI_ICE_CREAM = (new Food.Builder()).hunger(6).saturation(0.42F).effect(() -> new EffectInstance(Effects.SLOWNESS, 100, 2), 1.0F).effect(() -> new EffectInstance(NeapolitanEffects.HARMONY.get(), 1200), 1.0F).build();
		public static final Food ADZUKI_BUN = (new Food.Builder()).hunger(5).saturation(0.6F).effect(() -> new EffectInstance(NeapolitanEffects.HARMONY.get(), 600), 1.0F).build();
		public static final Food ROASTED_ADZUKI_BEANS = (new Food.Builder()).hunger(4).saturation(0.3F).effect(() -> new EffectInstance(NeapolitanEffects.HARMONY.get(), 200), 1.0F).build();
		public static final Food ADZUKI_MILKSHAKE = (new Food.Builder()).hunger(3).saturation(0.6F).build();
		...
		public static final Food MINT_CHOCOLATE = (new Food.Builder()).hunger(6).saturation(0.55F).effect(() -> new EffectInstance(NeapolitanEffects.SUGAR_RUSH.get(), 200), 1.0F).effect(() -> new EffectInstance(NeapolitanEffects.BERSERKING.get(), 100), 1.0F).build();
		public static final Food ADZUKI_CURRY = (new Food.Builder()).hunger(6).saturation(1.2F).effect(() -> new EffectInstance(NeapolitanEffects.HARMONY.get(), 300), 1.0F).build();
