...
public class NeapolitanItems {
    ...
    public static final RegistryObject<Item> CHOCOLATE_MILKSHAKE    = HELPER.createItem("chocolate_milkshake", () -> new MilkshakeItem(EffectType.HARMFUL, new Item.Properties().food(FoodValues.CHOCOLATE_STRAWBERRIES).maxStackSize(16).group(ItemGroup.FOOD)));
    ...
    public static final RegistryObject<Item> VANILLA_MILKSHAKE      = HELPER.createItem("vanilla_milkshake", () -> new MilkshakeItem(EffectType.NEUTRAL, new Item.Properties().food(FoodValues.CHOCOLATE_STRAWBERRIES).maxStackSize(16).group(ItemGroup.FOOD)));
