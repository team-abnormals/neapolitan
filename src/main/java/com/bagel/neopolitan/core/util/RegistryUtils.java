...
public class RegistryUtils {
	...
	public static <I extends Item> RegistryObject<I> createItem(String name, Supplier<? extends I> supplier) {
		RegistryObject<I> item = NeopolitanItems.ITEMS.register(name, supplier);
		return item;
	}
	...
	public static <B extends Block> RegistryObject<B> createBlock(String name, Supplier<? extends B> supplier, ItemGroup itemGroup) {
        RegistryObject<B> block = NeopolitanBlocks.BLOCKS.register(name, supplier);
        NeopolitanItems.ITEMS.register(name, () -> new BlockItem(block.get(), new Item.Properties().group(itemGroup)));
        return block;
    }
	...
	public static <B extends Block> RegistryObject<B> createBlockCompat(String mod, String name, Supplier<? extends B> supplier, ItemGroup itemGroup) {
		...
		RegistryObject<B> block = NeopolitanBlocks.BLOCKS.register(name, supplier);
		NeopolitanItems.ITEMS.register(name, () -> new BlockItem(block.get(), new Item.Properties().group(determinedGroup)));
		return block;		
    }
    ...
    public static <I extends Item> RegistryObject<I> createCompatItem(String mod, String name, Supplier<? extends I> compat_supplier, Supplier<? extends I> supplier) {
    	...
    	RegistryObject<I> item = NeopolitanItems.ITEMS.register(name, determinedSupplier);
		return item;
	}
}
