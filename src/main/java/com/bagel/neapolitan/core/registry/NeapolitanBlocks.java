...
import com.bagel.neapolitan.common.block.VerticalSlabBlock;
...
public class NeapolitanBlocks {
	public static final DeferredRegister<Block> BLOCKS = new DeferredRegister<>(ForgeRegistries.BLOCKS, Neapolitan.MODID);
